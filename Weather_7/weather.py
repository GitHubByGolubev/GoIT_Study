...
# Ініціалізуємо вікно
window = tk.Tk()
window.title("Weather of 7-Days App")
window.geometry("400x900")

window.configure(bg="#3498db")

# Додаємо кнопку для погоди
search_button = tk.Button(window, text="Get Weather", command=get_weather, bg="#2ecc71", fg="black", relief="flat")
search_button.grid(row=0, column=0, columnspan=2, pady=10, padx=150, sticky="n")
